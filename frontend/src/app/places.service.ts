...
////////////////////////////////////////////////////////////////////////////////////
  ...
  findStations(placeName) {
    ...
    var str = JSON.stringify(find_stations_at, null, 7);
  ...
  pulledNewStationDocksDataFromServer = (stationName, timeRange): Observable<Station[]> => {
    ...
    getDivvyTripsCountsPerDay(day,selectedDate){
      ...
      var str = JSON.stringify(find_stations_at, null, 2);
      let url =`${this.uri}/countDivvyTripsPerDay`

      console.log("${this.uri}/countDivvyTripsPerDay",url)
    ...
    getDivvyTripsCountsForSunday() {
      console.log("into getDivvyTripsCountsForSunday")

      let xx = this.http.get(`${this.uri}/getDivvyTripsCountsSunday`);
      // xx 是 object 
      console.log("getDivvyTripsCountsForSunday() return value",xx, typeof(xx))
      return xx;
    }
